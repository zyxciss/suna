...
export function FileAttachment({
    ...
    if (isImage && showPreview) {
        ...
        const imageHeight = isGridLayout && customStyle && '--attachment-height' in customStyle
    ...
    const safeStyle = { ...customStyle } as React.CSSProperties;
    delete safeStyle.height;
    // Handle custom CSS property safely
    if (safeStyle && '--attachment-height' in safeStyle) {
        const styleCopy = { ...safeStyle };
        delete (styleCopy as any)['--attachment-height'];
        return styleCopy;
    }
